...
val LaundryGothicFamily = FontFamily(
 ...
 * 행간 계산하는 메서드
 * */
private fun lineHeightPercent(fontSizeSp: Float, percent: Float): TextUnit =
    (fontSizeSp * (percent / 100f)).sp

/**
 * 자간 계산하는 메서드
 * */
private fun letterSpacingPercent(fontSizeSp: Float, percent: Float): TextUnit =
    (fontSizeSp * (percent / 100f)).sp